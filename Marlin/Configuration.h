...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 53.99
  #define DEFAULT_bedKi 3.47
  #define DEFAULT_bedKd 559.51
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, 6, -5.7 }
...
#define INVERT_Z_DIR true // inverted because Z-Motors on bottom
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_COLOR { 60, 60, 60, 0 } // R, G, B, W
#endif

 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47, 0, -0.7 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 67, 10, 20, 10 } // (mm) Left, Front, Right, Back insets
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    P2_12       // LED driving pin

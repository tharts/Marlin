...
#define STRING_CONFIG_H_AUTHOR "(T. Arts)" // Who made the changes.
...
//#define HOTEND_OFFSET_X {0.0, -17.65} // (mm) relative X-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  35.31 }
    #define DEFAULT_Ki_LIST {   2.93 }
    #define DEFAULT_Kd_LIST { 106.39 }
  #else
    #define DEFAULT_Kp  42.21
    #define DEFAULT_Ki   4.5
    #define DEFAULT_Kd 98.86
  #endif
#endif // PIDTEMP
...
//#define Z_ROD_PITCH 2.0  // old lead rod
#define Z_ROD_PITCH 8.0

#define WADE_PULLEY_TEETH 22.0
#define WADE_GEAR_TEETH 66.0
//#define HOBBED_BOLT_DIAM 7.2 // Titan Extruder
#define HOBBED_BOLT_DIAM 6.854 // Bondtech BMG Extruder
...
#define ENG2_E_STEPS WADE_E_STEPS
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, 821.82, 834.0, 834.0 }
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3265.3, 834.00, 834.0 }  // doubled because of 1/32 steps instead 1/16 steps
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 15, 75 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25, 35, -1.8 }
...
#define INVERT_X_DIR true // TMC 2130 false, for TMC5160 true
#define INVERT_Y_DIR true // TMC 2130 false, for TMC5160 true
#define INVERT_Z_DIR false // inverted because Z-Motors on bottom
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 25, 60, 25, 60 } // (mm) Left, Front, Right, Back insets
...
//  #define Z_SAFE_HOMING_Y_POINT 220 //((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    P0_17 // P2_12       // LED driving pin
  ...
  #define NEOPIXEL_BRIGHTNESS 40  // Initial brightness (0-255)
  ...
  #define NEOPIXEL_BKGD_LED_INDEX  4               // Index of the LED to use
  #define NEOPIXEL_BKGD_COLOR { 40, 40, 40, 0 } // R, G, B, W
#endif
